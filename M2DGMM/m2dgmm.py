...
def M2DGMM(y, n_clusters, r, k, init, var_distrib, nj, it = 50, \
    ...
    n_clusters (int or str): The number of clusters to look for in the data or the use mode of the M2DGMM
